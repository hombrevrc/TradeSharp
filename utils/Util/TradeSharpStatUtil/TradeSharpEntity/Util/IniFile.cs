...
namespace TradeSharpEntity.Util
{
    public class IniFile
    {
        ...
        //public static T GetParamValue<T>(Dictionary<string, string> keyVal, string key, T defaultValue)
        //{
        //    string valStr;
        //    if (!keyVal.TryGetValue(key, out valStr)) return defaultValue;
        //    try
        //    {
        //        return Converter.GetObjectFromString<T>(valStr);
        //    }
        //    catch
        //    {
        //        Logger.Error($"IniFile: can not parse \"{valStr}\" into {typeof(T).Name}");
        //        return defaultValue;
        //    }
        //}
